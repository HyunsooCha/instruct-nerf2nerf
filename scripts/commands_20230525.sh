...
CUDA_VISIBLE_DEVICES=0 ns-render --load-config outputs/yonwoo/in2n/image_cfg_2dot3/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/image_cfg_2dot3.mp4
CUDA_VISIBLE_DEVICES=1 ns-render --load-config outputs/yonwoo/in2n/image_cfg_2dot4/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/image_cfg_2dot4.mp4
CUDA_VISIBLE_DEVICES=2 ns-render --load-config outputs/yonwoo/in2n/image_cfg_2dot5/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/image_cfg_2dot5.mp4
CUDA_VISIBLE_DEVICES=3 ns-render --load-config outputs/yonwoo/in2n/image_cfg_2dot6/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/image_cfg_2dot6.mp4
