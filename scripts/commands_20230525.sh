...
CUDA_VISIBLE_DEVICES=2 ns-render --load-config outputs/yonwoo/in2n/2023-05-22_162114/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/2023-05-22_162114.mp4
CUDA_VISIBLE_DEVICES=3 ns-render --load-config outputs/yonwoo/in2n/2023-05-22_162407/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/2023-05-22_162407.mp4
CUDA_VISIBLE_DEVICES=4 ns-render --load-config outputs/yonwoo/in2n/2023-05-22_162543/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/2023-05-22_162543.mp4
CUDA_VISIBLE_DEVICES=5 ns-render --load-config outputs/yonwoo/in2n/2023-05-22_162555/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/2023-05-22_162555.mp4
CUDA_VISIBLE_DEVICES=6 ns-render --load-config outputs/yonwoo/in2n/2023-05-22_162603/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/2023-05-22_162603.mp4
CUDA_VISIBLE_DEVICES=7 ns-render --load-config outputs/yonwoo/in2n/2023-05-22_162610/config.yml --traj filename --camera-path-filename data/datasets/yonwoo/camera_paths/2023-05-16_215645.json --output-path renders/yonwoo/2023-05-22_162610.mp4